...
import com.BLEAndroid.utils.HexUtil;
...
public class DetailsCharacteristicFragment extends Fragment {
    ...
    public void showData() {
        final BleDevice bleDevice = ((DeviceDetailsActivity) getActivity()).getBleDevice();
        final BluetoothGattCharacteristic characteristic = ((DeviceDetailsActivity) getActivity()).getCharacteristic();
        final int charaProp = ((DeviceDetailsActivity) getActivity()).getCharaProp();
